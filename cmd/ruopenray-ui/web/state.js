...
export function createInitialState() {
  ...
  routePresetSources: [],
  routePresetSourceUrl: 'https://raw.githubusercontent.com/AceAsket/RuOpenRay-Keenetic/main/scenarios.json',
  routePresetSourceName: 'RuOpenRay Keenetic scenarios',
  ...
  keeneticSettings: null,
  keeneticSettingsSaving: false,
  keeneticIpv6Mode: 'observe',
  keeneticEntwareProxy: false,
  keeneticFdMonitor: true,
  keeneticDscpMode: 'off',
  keeneticDscpProxy: '63',
  keeneticDscpDirect: '62',
  keeneticNativePolicyMode: 'manual',
  keeneticIpExcludeText: '',
  keeneticPortProxyText: '',
  keeneticPortExcludeText: '',
  keeneticDownloadRetries: '3',
  keeneticOfflineInstall: false,
  keeneticAdguardCompatMode: 'observe',
  storageReport: null,
  storageCleaning: '',
